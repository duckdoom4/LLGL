    ...
    std::uint32_t           layerStride)
{
    ...
    {
        case TextureType::Texture1DArray:
            GetStateManager().DispatchBuiltin(D3D11BuiltinShader::CopyBufferFromTexture1DCS, srcExtent.x, srcExtent.y, 1u);
            break;
        case TextureType::Texture2DArray:
            GetStateManager().DispatchBuiltin(D3D11BuiltinShader::CopyBufferFromTexture2DCS, srcExtent.x, srcExtent.y, srcExtent.z);
            break;
        case TextureType::Texture3D:
            GetStateManager().DispatchBuiltin(D3D11BuiltinShader::CopyBufferFromTexture3DCS, srcExtent.x, srcExtent.y, srcExtent.z);
            break;
        default:
            break;
    }
    ...
    std::uint32_t           layerStride)
{
    ...
    {
        case TextureType::Texture1DArray:
            GetStateManager().DispatchBuiltin(D3D11BuiltinShader::CopyTexture1DFromBufferCS, dstExtent.x, dstExtent.y, 1u);
            break;
        case TextureType::Texture2DArray:
            GetStateManager().DispatchBuiltin(D3D11BuiltinShader::CopyTexture2DFromBufferCS, dstExtent.x, dstExtent.y, dstExtent.z);
            break;
        case TextureType::Texture3D:
            GetStateManager().DispatchBuiltin(D3D11BuiltinShader::CopyTexture3DFromBufferCS, dstExtent.x, dstExtent.y, dstExtent.z);
            break;
        default:
            break;
    }
